...
?>
    ...
    <div class="heading">
     <strong>Want to contact <span class="edit"> Abdullah's Cafe</span>?</strong>
     <br>
    ...
    <div class="col-md-5" style="float: none; margin: 0 auto;">
      <div class="form-area">
        ...
        <br style="clear: both">
          ...
          <div class="form-group">
            <input type="Number" class="form-control" id="mobile" name="mobile" placeholder="Mobile Number (Also add your country code too)" required>
          </div>
